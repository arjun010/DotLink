...
function addNewNode(){
    ...
    if(companyExistsInNodes(companyToAdd.value)==-1){
        nodes.push(JSON.parse('{"name":"'+companyToAdd.value+'", "expanded":"false","selected":"false","type":"'+getCompanyType(companyToAdd.value)+'","sector":"'+getSector(companyToAdd.value)+'","sectorColor":"'+getSectorColor(companyToAdd.value)+'","sectorDesc":"'+getSectorDesc(companyToAdd.value)+'"}'));
...
function addPartners(forCompany){
    ...
    for (var i = 0; i < alliances.length; i++) {
        if(alliances[i]['company1']==forCompany){
            ...
            targetVal = companyExistsInNodes(alliances[i]['company2']);
            if(targetVal==-1){
                nodes.push(JSON.parse('{"name":"'+alliances[i]['company2']+'", "expanded":"false","selected":"false","type":"'+getCompanyType(alliances[i]['company2'])+'","sector":"'+getSector(companyToAdd.value)+'","sectorColor":"'+getSectorColor(companyToAdd.value)+'","sectorDesc":"'+getSectorDesc(companyToAdd.value)+'"}'));
                targetVal = companyExistsInNodes(alliances[i]['company2']);
                links.push(JSON.parse('{"source":'+sourceVal+',"target":'+targetVal+'}'));
            }
            else{
          ...
          sourceVal = companyExistsInNodes(alliances[i]['company1']);
          if(sourceVal==-1){
                nodes.push(JSON.parse('{"name":"'+alliances[i]['company1']+'", "expanded":"false","selected":"false","type":"'+getCompanyType(alliances[i]['company1'])+'","sector":"'+getSector(companyToAdd.value)+'","sectorColor":"'+getSectorColor(companyToAdd.value)+'","sectorDesc":"'+getSectorDesc(companyToAdd.value)+'"}'));
                sourceVal = companyExistsInNodes(alliances[i]['company1']);
                links.push(JSON.parse('{"source":'+sourceVal+',"target":'+targetVal+'}'));
            }
            else{
